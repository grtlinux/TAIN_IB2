...
typedef MSG_SHC_HDR  MSG_HDR ;
typedef MSG_SHC_LINE MSG_LINE;
typedef MSG_SHC_0600 MSG_MANG;
typedef MSG_SHC_0630 MSG_FILE;
typedef MSG_SHC_0310 MSG_DATA;
typedef MSG_SHC_0620 MSG_MREQ;
typedef MSG_SHC_0300 MSG_MRES;
