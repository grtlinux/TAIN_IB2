...
/*----------------------------------------------------------------------------*/
{
    ...
    if (flag)
    {
        ...
        if (flag)
        {
            ...
            if (!flag) LOG(_FL_, 0, 0, "[SendDataEDI]...iSendEdiLen=%d [%d:%s] ", iSendEdiLen, strlen(sSendEdiLine), sSendEdiLine);
        }
    ...
    if (flag)
    {
        ...
        if (flag)
        {
            ...
            if (flag)
            {
                ...
                if (flag) LOG(_FL_, 0, 0, "한개 Msg에 넣을 수 있는 record 건수 : iMsgRecs=%d", iMsgRecs);
