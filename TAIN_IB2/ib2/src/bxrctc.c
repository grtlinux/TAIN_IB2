...
typedef MSG_CTC_HDR    MSG_HDR ;
typedef MSG_CTC_LINE   MSG_LINE;
typedef MSG_CTC_0600   MSG_MANG;
typedef MSG_CTC_0630   MSG_FILE;
typedef MSG_CTC_0310   MSG_DATA;
typedef MSG_CTC_0620   MSG_MREQ;
typedef MSG_CTC_0300   MSG_MRES;
