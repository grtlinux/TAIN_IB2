...
/*============================================================================*/
/*
 * EDI 배치 관련 헤더 : KFT53, KFT54, KFT55
 *
 *    typedef struct _MSG_HDR_KFT2_  // (23)
 *    {
 *        char    sMsgLen   [   4];  // TCP/IP 전문송신 Byte수
 *        char    sBizKnd   [   3];  // 업무구분코드 'KTB'
 *        char    sOrgzCd   [   8];  // 금융기관코드 65913324 67110257 65900073
 *        char    sMsgCls   [   4];  // 전문종별코드
 *        char    sTrxCls   [   1];  // 거래구분코드 'S', 'R'
 *        char    sSrFlag   [   1];  // 송수신 Flag C:Center, B:Bank
 *        char    sFileNm   [   8];  // 파일구분코드  0600/001, 0600/004, MMDD
 *        char    sRespCd   [   3];  // 응답코드
 *    } MSG_KFT2_HDR;
 *
 */
...
typedef MSG_KFT2_HDR  MSG_HDR ;
typedef MSG_KFT2_LINE MSG_LINE;
typedef MSG_KFT2_0600 MSG_MANG;
typedef MSG_KFT2_0630 MSG_FILE;
typedef MSG_KFT2_0310 MSG_DATA;
typedef MSG_KFT2_0620 MSG_MREQ;
typedef MSG_KFT2_0300 MSG_MRES;
