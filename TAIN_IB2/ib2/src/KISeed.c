/*
 * PROGRAM ID   : KISeed.c
 * PROGRAM NAME : KISeed 모듈
 * HISTORY      : 2013.10.17 강석. 
 *
 */
...
int main()
{
	...
	BYTE pbUserKey[16] = {0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 		// User secret key
                        0x39, 0x30, 0x41, 0x42, 0x43, 0x44, 0x45, 0x46};
						   
	BYTE pbData[16]    = {0x37, 0x34, 0x31, 0x32, 0x32, 0x31, 0x31, 0x32, 		// input plaintext to be encrypted
                        0x33, 0x34, 0x35, 0x36, 0x37, 0x20, 0x20, 0x20};
...
// Compare with : 1F 37 DE 36 F1 38 DA 49 C1 EA 1F 73 61 0C 19 71
